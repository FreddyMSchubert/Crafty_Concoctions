...
public class ModEffects
{
    ...
    public static final RegistryEntry<StatusEffect> JUMP_REDUCTION = register("jump_reduction", new JumpReductionStatusEffect(StatusEffectCategory.HARMFUL, 0x00FF00));
    ...
    public static final RegistryEntry<StatusEffect> BREATHLESSNESS = register("jump_reduction", new BreathlessnessStatusEffect(StatusEffectCategory.HARMFUL, 0x00FF00));
