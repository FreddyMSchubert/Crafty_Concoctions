...
public class ModDataComponentTypes
{
    ...
    public static final ComponentType<String> CUSTOM_POTION_NAME = ComponentType.<String>builder().codec(Codec.STRING).packetCodec(PacketCodecs.STRING).build();
    ...
    public static void register()
    {
        ...
        Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(CraftyConcoctions.MOD_ID, "custom_potion_name"), CUSTOM_POTION_NAME);
